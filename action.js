// Global references for the board, apple, snake, and timer objects.
var boardobj;
var appleobj;
var snakeobj;
var runobj;
...
// Tracks the current snake length and movement state.
var snakeLength = 0;
// Default width & height for both Snake and Apple (Note you change the board width and height in style.css file)
var blockSize = 30;
var nextMoveAllow = 1;

// Temporary variables used during movement, collision checks, and apple placement.
var temp = 0;
var tempSnakeLeft;
var tempSnakeTop;
var secondTemp = 0;
...
// Board and snake position values used throughout the game logic.
var boardTop;		
var boardLeft;	
var appleTop;	
var appleLeft;
...
// Initialize the game board and the starting snake element.
function start() {
...
// Run one game tick: decide the next movement of the snake head.
function run() {
...
// Grow the snake and add a new body segment when it reaches the apple.
function eat() {
...
// Place the apple at a random open tile on the board.
...
// Move the snake body forward after each update and detect collisions.
function follow() {
	if(snakeLength >= 1) {
		nextMoveAllow = 1;
		temp = snakeLength;
...
// Find an alternate valid movement for the snake when a direct path is blocked.
...
// Script starting point: initialize the game and start the game loop.
start();
